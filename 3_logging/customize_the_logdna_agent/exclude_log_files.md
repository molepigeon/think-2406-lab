...
1.  Make changes. Add the section LOGDNA_EXCLUDE, and exclude calico-node logs. Add to the yaml file:
...
To exclude all non- container logs, that is to exclude files as shown in the All Apps filter view,
...
1.  Verify that calico-node entries are not showing in the LogDNA web UI.